...
public class UserTableModel extends AbstractTableModel{
	...
	public void searchOnAll() {
		userModel  = userDAO.searchAll();
	}
	
	public void searchOnUserID(String option) {
		userModel  = userDAO.searchUserID(option);
	}
	
	public void searchOnLName(String option) {
		userModel  = userDAO.searchLName(option);
	}
	
	public void searchOnFName(String option) {
		userModel  = userDAO.searchFName(option);
	}
		
	public void searchOnPosition(String option) {
		userModel  = userDAO.searchPosition(option);
	}
	
	public void searchOnAccessLevel(String option) {
		userModel  = userDAO.searchAccessLevel(option);
	}
		
	public void searchOnTeam(String option) {
		userModel  = userDAO.searchTeam(option);
	}
		
	public void searchOnEmail(String option) {
		userModel  = userDAO.searchEmail(option);
	}
